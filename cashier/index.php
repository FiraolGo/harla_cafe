...
<body>
    <!-- SIDEBAR -->
    <section id="sidebar">
        <a href="#" class="brand"><i class='bx bxs-smile icon'></i> Cashier</a>
        <ul class="side-menu">
            ...
            <li>
                ...
                <ul class="side-dropdown">
                    ...
                    <li><a href="#"  id="load-payment-list">Generate Bills</a></li>
                </ul>
            </li>
            
            <a href="#"><i class='bx bxs-inbox icon'></i> Transaction History </a>
            <a href="#"><i class='bx bxs-inbox icon'></i> Daily Summary </a>
            <li class="divider"></li>
